...
set matchpairs=(:),{:},[:],<:>
set ruler
set runtimepath=~/vimfiles,~\\vimfiles\\bundle\\Vundle.vim,~\\vimfiles\\bundle\\rust.vim,~\\vimfiles\\bundle\\molokai,C:\\Program\ Files\ (x86)\\Vim/vimfiles,C:\\Program\ Files\ (x86)\\Vim\\vim74,C:\\Program\ Files\ (x86)\\Vim/vimfiles/after,~/vimfiles/after,~/vimfiles/bundle/Vundle.vim/,~\\vimfiles\\bundle\\Vundle.vim/after,~\\vimfiles\\bundle\\rust.vim/after,~\\vimfiles\\bundle\\molokai/after
set scrolljump=5
set scrolloff=10
...
set shortmess=aoO
badd +148 Session.vim
badd +63 src\win32.rs
badd +275 src\game\mod.rs
...
badd +40 src\game\math.rs
badd +37 src\game\world.rs
args src\win32.rs
edit src\game\graphics.rs
...
silent! normal! zE
let s:l = 119 - ((28 * winheight(0) + 29) / 58)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 669 - ((23 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
669
