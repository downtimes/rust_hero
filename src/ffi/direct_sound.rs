...
pub struct IDirectSoundBufferVtbl {
    ...
    pub Initialize: *const c_void,
    pub Lock: extern "system" fn(this: *mut IDirectSoundBuffer, dwOffset: DWORD, dwBytes: DWORD, 
                                 ppvAudioPtr1: *mut *mut c_void, pdwAudioBytes1: *mut DWORD,
                                 ppvAudioPtr2: *mut *mut c_void, pdwAudioBytes2: *mut DWORD,
                                 dwFlags: DWORD) -> HRESULT,
    pub Play: extern "system" fn (this: *mut IDirectSoundBuffer, dwReserved1: DWORD,
                                  dwPriority: DWORD, dwFlags: DWORD) -> HRESULT,
    pub SetCurrentPosition: *const c_void,
    pub SetFormat: extern "system" fn (this: *mut IDirectSoundBuffer, pcfxFormat: *const WAVEFORMATEX)
                                       -> HRESULT,
    ...
    pub Unlock: extern "system" fn(this: *mut IDirectSoundBuffer, 
                                 pvAudioPtr1: *mut c_void, dwAudioBytes1: DWORD,
                                 pvAudioPtr2: *mut c_void, dwAudioBytes2: DWORD)
                                 -> HRESULT,
